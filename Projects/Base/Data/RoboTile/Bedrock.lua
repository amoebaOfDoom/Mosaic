...
tile_bottom_right_inside_corner = 0x161

tile_half_bottom_edge = 0x14A
tile_under_half_bottom_edge = 0x14B

tile_half_right_edge = 0x14E
tile_beside_half_right_edge = 0x14F

tile_bottom_right_45_slope = 0x160
tile_under_bottom_right_45_slope = 0x161

tile_bottom_right_45_small_slope = 0x140
tile_bottom_right_45_large_slope = 0x141

tile_bottom_right_gentle_slope_small = 0x164
tile_bottom_right_gentle_slope_large = 0x165
tile_under_bottom_right_gentle_slope_small = 0x166
tile_under_bottom_right_gentle_slope_large = 0x171
